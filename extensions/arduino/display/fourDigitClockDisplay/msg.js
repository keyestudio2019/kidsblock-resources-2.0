...
function addMsg (Blockly) {
    ...
    Object.assign(Blockly.ScratchMsgs.locales['de'], {
        FOURDIGITCLOCKDISPLAY_CATEGORY: '4-stellige Uhranzeige',
        FOURDIGITCLOCKDISPLAY_INIT: '4-stelligen Uhranzeige-Pin DIO %1 CLK %2 initiieren',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['es'], {
        FOURDIGITCLOCKDISPLAY_CATEGORY: 'Pantalla de reloj de 4 dígitos',
        FOURDIGITCLOCKDISPLAY_INIT: 'iniciar pin de pantalla de reloj de 4 dígitos DIO %1 CLK %2',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['fr'], {
        FOURDIGITCLOCKDISPLAY_CATEGORY: 'Affichage de l"horloge à 4 chiffres',
        FOURDIGITCLOCKDISPLAY_INIT: 'initialisation de la broche d"affichage de l"horloge à 4 chiffres DIO %1 CLK %2',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ja'], {
        FOURDIGITCLOCKDISPLAY_CATEGORY: '4 桁の時計表示',
        FOURDIGITCLOCKDISPLAY_INIT: '4 桁の時計表示ピン DIO %1 CLK %2 を初期化',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ko'], {
        FOURDIGITCLOCKDISPLAY_CATEGORY: '4자리 시계 표시',
        FOURDIGITCLOCKDISPLAY_INIT: '초기화 4자리 시계 디스플레이 핀 DIO %1 CLK %2',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['pl'], {
        FOURDIGITCLOCKDISPLAY_CATEGORY: '4-cyfrowy wyświetlacz zegara',
        FOURDIGITCLOCKDISPLAY_INIT: 'początkowy 4-cyfrowy pin wyświetlacza zegara DIO %1 CLK %2',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['pt'], {
        FOURDIGITCLOCKDISPLAY_CATEGORY: 'Exibição do relógio de 4 dígitos',
        FOURDIGITCLOCKDISPLAY_INIT: 'inicializar pino de exibição de relógio de 4 dígitos DIO %1 CLK %2',
        FOURDIGITCLOCKDISPLAY_SETBRIGHTNESS: 'definir brilho %1',
        FOURDIGITCLOCKDISPLAY_DISPLAYNUMBER: 'mostrar número %1',
        OURDIGITCLOCKDISPLAY_DISPLAYSTRING: 'exibir string %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ru'], {
        ...
        FOURDIGITCLOCKDISPLAY_INIT: 'инициировать 4-значный вывод часов на вывод DIO %1 CLK %2',
        FOURDIGITCLOCKDISPLAY_SETBRIGHTNESS: 'установить яркость% 1',
        FOURDIGITCLOCKDISPLAY_DISPLAYNUMBER: 'отображаемый номер %1',
        FOURDIGITCLOCKDISPLAY_DISPLAYSTRING: 'строка отображения %1',
        FOURDIGITCLOCKDISPLAY_DISPLAY: 'отобразить %1 в бите %2',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['zh-tw'], {
        ...
        FOURDIGITCLOCKDISPLAY_INIT: '初始化4位時鐘數碼管引腳 DIO %1 CLK %2',
