...
<block type="bbrgbLedStrip_display" id="bbrgbLedStrip_display">
    ...
    <value name="MATRIX_SEVEN">
    <shadow type="matrix_seven">
        <field name="MATRIX_SEVEN">01000101010101000000000101000001000</field>
    </shadow>
    </value>
...
<category name="%{BKY_QMI8658_CATEGORY}" id="QMI8658_CATEGORY" colour="#8a2be2" secondaryColour="#BBBB00" >
    <block type="QMI8658_init" id="QMI8658_init">

    </block>

    <block type="QMI8658_read" id="QMI8658_read">
