...
Blockly.Arduino.AHT20_21 = function() {
    ...
    Blockly.Arduino.bbrgbLedStrip_display = function(block) {
        ...
        const arr = Blockly.Arduino.valueToCode(this, 'MATRIX_SEVEN', Blockly.Arduino.ORDER_ASSIGNMENT);
        const color = Blockly.Arduino.valueToCode(block, 'COLOR', Blockly.Arduino.ORDER_ATOMIC).replace('#', '0x');
        Blockly.Arduino.definitions_['arry'] = 'int arry[35];\n';
    ...
    Blockly.Arduino.rgb_change=function(block) {
        ...
        if (!Blockly.Arduino.definitions_['var_rgb_display' + dropdown_rgbpin]) {
          Blockly.Arduino.definitions_['var_rgb_display' + dropdown_rgbpin] = 'Adafruit_NeoPixel  rgb_display_'+dropdown_rgbpin+'(35,'+dropdown_rgbpin+', NEO_GRB + NEO_KHZ800);';
          Blockly.Arduino.setups_['setup_rgb_display_begin_' + dropdown_rgbpin] = 'rgb_display_'+dropdown_rgbpin+'.begin();';
          '(35,'+ dropdown_rgbpin +', NEO_GRB + NEO_KHZ800);';
    ...
    Blockly.Arduino.QMI8658_init = function (block) {
        Blockly.Arduino.includes_.include_QMI8658_init = `#include <QMI8658.h>\n#include <Wire.h>`;
        Blockly.Arduino.definitions_[`QMI8658_1`] = `QMI8658 qmi8658;`;
        Blockly.Arduino.setups_['getAddress'] ='Wire.begin();\n'  
        +'if (qmi8658.begin() == 0)\n' 
        +'{\n'
    ...
    Blockly.Arduino.QMI8658_read = function (block) {  
        const unit = this.getFieldValue('unit'); // 获取用户选择的单位  
        Blockly.Arduino.definitions_[`QMI8658_2`] = `float pitch, roll, yaw;`;
        Blockly.Arduino.loops_['QMI8658_2'] = `qmi8658.GetEulerAngles(&pitch, &roll, &yaw);`;  
