...
function addMsg (Blockly) {
    Object.assign(Blockly.ScratchMsgs.locales.en, {
        ...
        QMI8658_CATEGORY: 'Acceleration',
        QMI8658_INIT: 'init QMI8658',
        QMI8658_READ: 'QMI8658 read %1',
        WIFI_CATEGORY: 'WIFI',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['de'], {
        ...
        KS_variables_declare: 'Deklariere %1 Zahlvariable Typ %2 Name %3 Wert %4',
        KS_variables_declare2: 'Deklariere %1 Zeichenkette-Variable Typ %2 Name %3 Wert %4',
        KS_variables_set: 'Setze %1 Variable auf %2',
        KS_variables_change: 'Ändere %1 Variable Modus %2',
        KS_variables_value: 'Variable %1',
        KS_variables_setString: 'Setze %1 Zeichenkette-Variable auf %2',
        KS_global: 'Global',
        KS_local: 'Lokal',
        KS_MATH_INT: 'Ganzzahl',
        KS_MATH_LONG: 'Lange Ganzzahl',
        KS_MATH_FLOAT: 'Gleitkommazahl',
        KS_MATH_BOOLEAN: 'Boolesch',
        KS_MATH_BYTE: 'Byte',
        KS_MATH_CHAR: 'Zeichen',
        KS_MATH_STRING: 'Zeichenkette',
        KS_MATH_UNSIGNED_INT: 'Vorzeichenlose Ganzzahl',
        KS_MATH_WORD: 'Wort',
        KS_MATH_UNSIGNED_LONG: 'Vorzeichenlose lange Ganzzahl',
        KS_MATH_UNSIGNED_CHAR: 'Vorzeichenloses Zeichen',
        KS_MATH_DOUBLE: 'Doppelte Genauigkeit',
        KS_TEXT_LABEL: 'Text',
        KS_char: 'char%1',
        KS_string: 'string%1',
        KS_data: '%1',
        ...
        BUTTON_READ_STATE: 'Taste %1 gedrückt?',
        BUTTON_READ_VALUE: 'Zustandswert der Taste %1',
        TOUCHSWITCH_CATEGORY: 'Berührung',
        TOUCHSWITCH_READ_VALUE: 'Wert der Berührung %1',
        TOUCHSWITCH_STATE: 'Berührung bei %1 erkannt?',
        BUZZER_CATEGORY: 'Musik',
        BUZZER_TONE: 'Ton abspielen Pin %1 Frequenz %2',
        BUZZER_TONE_D: 'Ton abspielen Pin %1 Frequenz %2 Dauer %3',
        BUZZER_MUSIC: 'Musik Pin %1 spiele Musik %2',
        BUZZER_NOTONE: 'Ton beenden Pin %1',

        BBRGBLEDSTRIP_CATEGORY: 'RGB',
        BBRGBLEDSTRIP_INIT: 'Initialisiere RGB Lichteranzahl %1 Pin %2',
        BBRGBLEDSTRIP_DISPLAY: 'RGB Helligkeit %1 Farbe %2 %3 anzeigen %4',
        BBRGBLEDSTRIP_SETPIXELCOLOR: 'Setze Pixel %1 Farbe %2',
        BBRGBLEDSTRIP_FILL: 'Fülle ab Pixel %1 bis Pixel %2 mit Farbe %3',
        BBRGBLEDSTRIP_COLOR: 'RGB Farbe R %1 G %2 B %3',
        BBRGBLEDSTRIP_SETBRIGHTNESS: 'Setze Helligkeit %1',
        RGB_CHANGE: 'Setze RGB Pin %1 Helligkeit %2 Farbwechselzeit %3',
        RGB_LOOP: 'Setze RGB Pin %1 Helligkeit %2 Farbzykluszeit %3',
        BBRGBLEDSTRIP_CLEAR: 'Alles löschen',
        BBRGBLEDSTRIP_SHOW: 'Aktualisieren',
        AHT21_CATEGORY: 'Temperatur und Luftfeuchtigkeit',
        AHT20_21: 'Erhalte Temperatur und Luftfeuchtigkeit %1',
        ANALOGVOICE_CATEGORY: 'Ton',
        ANALOGVOICE_READ_VALUE: 'Lese Soundlevel von Schnittstelle %1',
        CURRENT_CATEGORY: 'Strom',
        CURRENT_READ_VALUE: 'Lese Strom von Schnittstelle',
        QMI8658_CATEGORY: 'Beschleunigung',
        QMI8658_INIT: 'Initialisiere Beschleunigung',
        QMI8658_READ: 'Lese Beschleunigung %1',
        WIFI_CATEGORY: 'WIFI',
        WIFI_INIT: 'Verbinde zu WiFi Netzwerkname%1 Passwort%2',
        WIFI_READ_IP: 'Lese WiFi IP',
        SD_CATEGORY: 'SD Karte',
        SD_INIT: 'Initialisiere SD Karte CS:%1 MOSI:%2 MISO:%3 SCK:%4',
        SD_REFRESH: 'SD Daten aktualisieren',
        SD_TYPE: 'SD Typ',
        SD_LIST: 'Liste Dateien im SD Rootverzeichnis',
        SD_VAR: 'Lese SD %1',
        SD_JUDGE: 'Existiert Datei %1?',
        SD_DELETE: 'Lösche %1',
        SD_READ: 'Lese %1',
        SD_WRITE: 'Schreibe in SD Datei %1 Daten %2 Neue Zeile %3',
        LIGHTSENSOR_CATEGORY: 'Licht',
        LIGHTSENSOR_READ_VALUE: 'Lese Lichtintensität von Schnittstelle %1'
    });
    Object.assign(Blockly.ScratchMsgs.locales['es'], {
        ...
        QMI8658_CATEGORY: 'Aceleración',
        QMI8658_INIT: 'iniciar QMI8658',

        QMI8658_READ: 'QMI8658 lectura %1',
        WIFI_CATEGORÍA: 'WIFI',
        WIFI_INIT: 'wifi connect ssid:%1 contraseña:%2',
        WIFI_READ_IP: 'WiFi leer ip',
        SD_CATEGORY: 'SD-Karte',
        SD_INIT: 'SD-Karte initialisieren CS: %1 MOSI:%2 MISO:%3 SCK:%4',
        SD_REFRESH: 'SD-Daten aktualisieren',
        SD_TYPE: 'SD-Typ',
        SD_LIST: 'Dateien auflisten',
        SD_VAR: 'SD %1',
        SD_JUDGE: '%1 Datei vorhanden?',
        SD_DELETE: '%1 löschen',
        SD_READ: '%1 lesen',
        SD_WRITE: 'SD-Datei %1 schreiben Daten %2 Neue Zeile %3',
        LIGHTSENSOR_CATEGORY: 'Licht',
        LIGHTSENSOR_READ_VALUE: 'Lichtwert von %1 lesen'
    });
    Object.assign(Blockly.ScratchMsgs.locales['fr'], {
        KS_VARIABLE_LABEL:'Type de variable',
         ...
         QMI8658_CATEGORY: 'Accélération',
         QMI8658_INIT: 'init QMI8658',

         QMI8658_READ: 'QMI8658 a lu %1',
         WIFI_CATEGORY: 'WIFI',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ja'], {
        KS_VARIABLE_LABEL:'変数タイプ',
         ...
         BBRGBLEDSTRIP_CATEGORY: 'RGB',
         BBRGBLEDSTRIP_INIT: 'RGB 初期化 灯の数 %1 ピン %2',
         BBRGBLEDSTRIP_DISPLAY: 'RGB 明るさ %1 色 %2 %3 表示 %4',
         BBRGBLEDSTRIP_SETPIXELCOLOR: 'ピクセル %1 の色 %2 を設定',
         BBRGBLEDSTRIP_FILL: 'ピクセル %1 から ピクセル %2 まで 色 %3',
         BBRGBLEDSTRIP_COLOR: 'RGB カラー R %1 G %2 B %3',
         BBRGBLEDSTRIP_SETBRIGHTNESS: '明るさを %1 に設定',
         RGB_CHANGE: 'RGBピン%1 明るさ%2 セブンカラー変化時間%3 を設定',
         RGB_LOOP: 'RGBピン%1 明るさ%2 セブンカラーループ時間%3 を設定',
         BBRGBLEDSTRIP_CLEAR: 'すべてクリア',
         BBRGBLEDSTRIP_SHOW: '更新',
         AHT21_CATEGORY: '温湿度',
         AHT20_21: '温湿度取得 %1',
         ANALOGVOICE_CATEGORY: '音声',
         ANALOGVOICE_READ_VALUE: 'インターフェース %1 の音声強度を読み取る',
         CURRENT_CATEGORY: '電流',
         CURRENT_READ_VALUE: 'インターフェースの電流を読み取る',
         QMI8658_CATEGORY: '加速度',
         QMI8658_INIT: '加速度初期化',
         QMI8658_READ: '加速度 %1 を読み取る',
         WIFI_CATEGORY: 'WIFI',
         WIFI_INIT: 'WiFi に接続 名称%1 パスワード%2',
         WIFI_READ_IP: 'WiFi IPアドレスを読み取る',
         SD_CATEGORY: 'SDカード',
         SD_INIT: 'SDカード 初期化 CS:%1 MOSI:%2 MISO:%3 SCK:%4',
         SD_REFRESH: 'SD データを更新',
         SD_TYPE: 'SDタイプ',
         SD_LIST: 'SDルートディレクトリのファイルをリスト',
         SD_VAR: 'SD%1 を読み取る',
         SD_JUDGE: '%1 のファイルは存在するか?',
         SD_DELETE: '%1 を削除',
         SD_READ: '%1 を読み取る',
         SD_WRITE: 'SD ファイル%1 にデータ%2 を書き込む 改行%3',
         LIGHTSENSOR_CATEGORY: '光線',
         LIGHTSENSOR_READ_VALUE: 'インターフェース%1 の光線強度を読み取る'
    });
    Object.assign(Blockly.ScratchMsgs.locales['ko'], {
        KS_VARIABLE_LABEL:'변수 유형',
         ...
         BBRGBLEDSTRIP_CATEGORY: 'RGB',
         BBRGBLEDSTRIP_INIT: 'RGB 길이 %1 핀 %2 초기화',
         BBRGBLEDSTRIP_DISPLAY: 'RGB 밝기%1 색상%2 %3 표시%4 ',
         ...
         RGB_CHANGE: 'RGB 핀 %1 밝기%2 전체 색상 변화 시간%3',
         RGB_LOOP: 'RGB 핀 %1 밝기%2 전체 색상 루프 시간%3',
         BBRGBLEDSTRIP_CLEAR: '모두 지우기',
         BBRGBLEDSTRIP_SHOW: '새로고침',
         AHT21_CATEGORY: '온도 및 습도',
         AHT20_21: '온도 및 습도 %1 얻기',
         ANALOGVOICE_CATEGORY: '소리',
         ANALOGVOICE_READ_VALUE: '소리 값 %1 읽기',
         CURRENT_CATEGORY: '전류',
         CURRENT_READ_VALUE: '전류 값 읽기',
         QMI8658_CATEGORY: '가속도',
         QMI8658_INIT: 'QMI8658 초기화',
         QMI8658_READ: 'QMI8658 %1 읽기',
         WIFI_CATEGORY: 'WIFI',
         WIFI_INIT: 'wifi 연결 ssid:%1 비밀번호:%2',
         WIFI_READ_IP: 'WiFi IP 읽기',
         SD_CATEGORY: 'SD 카드',
         SD_INIT: 'SD 카드 초기화 CS: %1 MOSI:%2 MISO:%3 SCK:%4',
         SD_REFRESH: 'SD 데이터 새로고침',
         SD_TYPE: 'SD 유형',
         SD_LIST: '파일 목록',
         SD_VAR: 'SD %1',
         ...
         SD_DELETE: '%1 삭제',
         SD_READ: '%1 읽기',
         SD_WRITE: 'SD 파일 %1 데이터 %2 새 줄 %3 쓰기',
         LIGHTSENSOR_CATEGORY: '빛',
         LIGHTSENSOR_READ_VALUE: '빛 값 %1 읽기'
    });
    Object.assign(Blockly.ScratchMsgs.locales['pl'], {
        ...
        QMI8658_CATEGORY: 'Przyspieszenie',
        QMI8658_INIT: 'zainicjuj QMI8658',

        QMI8658_READ: 'QMI8658 odczyt %1',
        WIFI_CATEGORY: 'WIFI',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['pt'], {
        KS_VARIABLE_LABEL:'Tipo de variável',
         ...
         QMI8658_CATEGORY: 'Aceleração',
         QMI8658_INIT: 'iniciar QMI8658',

         QMI8658_READ: 'QMI8658 leu %1',
         WIFI_CATEGORY: 'WIFI',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ru'], {
        KS_VARIABLE_LABEL: 'Тип переменной',
         ...
         QMI8658_CATEGORY: 'Ускорение',
         QMI8658_INIT: 'инициализировать QMI8658',

         QMI8658_READ: 'QMI8658 прочитал %1',
         WIFI_CATEGORY: "WI-FI",
    ...
    Object.assign(Blockly.ScratchMsgs.locales['zh-tw'], {
        ...
        QMI8658_CATEGORY: '加速度',
        QMI8658_INIT: '初始化 加速度',
        QMI8658_READ: '讀取加速度 %1',
        WIFI_CATEGORY: 'WIFI',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['it'], {     
        ...
        BUTTON_READ_STATE: 'Pulsante %1 è premuto?',
        BUTTON_READ_VALUE: 'Stato pulsante %1',
        TOUCHSWITCH_CATEGORY: 'Tocco',
        TOUCHSWITCH_READ_VALUE: 'Valore del tocco %1',
        TOUCHSWITCH_STATE: '%1 rilevato tocco?',
        BUZZER_CATEGORY: 'Musica',
        BUZZER_TONE: 'Suonare suono Pin %1 Frequenza %2',
        BUZZER_TONE_D: 'Suonare suono Pin %1 Frequenza %2 Battito %3',
        BUZZER_MUSIC: 'Musica Pin %1 Suonare musica %2',
        BUZZER_NOTONE: 'Fermare suono Pin %1',
        BBRGBLEDSTRIP_CATEGORY: 'RGB',
        BBRGBLEDSTRIP_INIT: 'Inizializzare RGB Numero di LED %1 Pin %2',
        BBRGBLEDSTRIP_DISPLAY: 'RGB luminosità %1 Colore %2 %3 Mostra %4',
        BBRGBLEDSTRIP_SETPIXELCOLOR: 'Impostare pixel %1 Colore %2',
        BBRGBLEDSTRIP_FILL: 'Da pixel %1 a pixel %2 Colore %3',
        BBRGBLEDSTRIP_COLOR: 'Colore RGB R %1 G %2 B %3',
        BBRGBLEDSTRIP_SETBRIGHTNESS: 'Impostare luminosità %1',
        RGB_CHANGE: 'Impostare pin RGB %1 luminosità %2 Tempo cambiamento arcobaleno %3',
        RGB_LOOP: 'Impostare pin RGB %1 luminosità %2 Tempo ciclo arcobaleno %3',
        BBRGBLEDSTRIP_CLEAR: 'Cancella tutto',
        BBRGBLEDSTRIP_SHOW: 'Aggiorna',
        AHT21_CATEGORY: 'Temperatura e umidità',
        AHT20_21: 'Ottenere temperatura e umidità %1',
        ANALOGVOICE_CATEGORY: 'Suono',
        ANALOGVOICE_READ_VALUE: 'Leggere valore suono dal pin %1',
        CURRENT_CATEGORY: 'Corrente',
        CURRENT_READ_VALUE: 'Leggere valore corrente dal pin',
        QMI8658_CATEGORY: 'Accelerometro',
        QMI8658_INIT: 'Inizializzare accelerometro',
        QMI8658_READ: 'Leggere accelerometro %1',
        WIFI_CATEGORY: 'WiFi',
        WIFI_INIT: 'Connettersi al WiFi Nome %1 Password %2',
        WIFI_READ_IP: 'Leggere IP WiFi',
        SD_CATEGORY: 'Scheda SD',
        SD_INIT: 'Inizializzare SD CS:%1 MOSI:%2 MISO:%3 SCK:%4',
        SD_REFRESH: 'Aggiorna dati SD',
        SD_TYPE: 'Tipo di SD',
        SD_LIST: 'Elencare i file nella directory principale della SD',
        SD_VAR: 'Leggere SD %1',
        SD_JUDGE: 'Il file %1 esiste?',
        SD_DELETE: 'Eliminare %1',
        SD_READ: 'Leggere %1',
        SD_WRITE: 'Scrivere su SD File %1 Dati %2 Nuova riga %3',
        LIGHTSENSOR_CATEGORY: 'Luce',
        LIGHTSENSOR_READ_VALUE: 'Leggere valore luce dal pin %1',        
    });
    return Blockly;
}
