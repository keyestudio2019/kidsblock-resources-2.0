...
function addMsg (Blockly) {
    Object.assign(Blockly.ScratchMsgs.locales.en, {
        ...
        MatrixDisplay_DISPLAY: 'matrix %1 display%2',
        MatrixDisplay_DRAWPIXEL: ' martix display draw pixel x: %1 y: %2',
        MatrixDisplay_COLOR_RED: 'red',
        MatrixDisplay_COLOR_BLACK: 'black',
        MatrixDisplay_DRAWLINE: ' martix display draw line x0: %1 y0: %2, x1: %3 y1: %4',
        MatrixDisplay_DRAWRECTANGLE: 'martix display draw rectangle x: %1 y: %2 :width %3 length: %4',
        MatrixDisplay_DRAWCIRCLE: 'martix display draw circle x: %1 y: %2 :radius %3 ',
        MatrixDisplay_SHOWCHAR: ' martix display show char or number: %1',
        MatrixDisplay_SHOW_LOOP: ' martix display loop show : %1',
        MatrixDisplay_IMAGE: ' martix display image %1'
    ...
    Object.assign(Blockly.ScratchMsgs.locales['de'], {
        ...
        MATRIXDISPLAY_CATEGORY: 'Matrixanzeige',
        MatrixDisplay_INIT: 'Matrixanzeige %1 initiieren',
        MatrixDisplay_DISPLAY: 'Matrix %1 Anzeige%2',
        MatrixDisplay_DRAWPIXEL: 'martix display draw pixel x: %1 y: %2',
        MatrixDisplay_COLOR_RED: 'rot',
        MatrixDisplay_COLOR_BLACK: 'schwarz',
        MatrixDisplay_DRAWLINE: 'martix display line x0: %1 y0: %2, x1: %3 y1: %4',
        MatrixDisplay_DRAWRECTANGLE: 'Martix Display zeichnet Rechteck x: %1 y: %2 :width %3 Länge: %4',
        MatrixDisplay_DRAWCIRCLE: 'martix display Zeichne Kreis x: %1 y: %2 :radius %3 ',
        MatrixDisplay_SHOWCHAR: 'martix display show char or number: %1',
        MatrixDisplay_SHOW_LOOP: 'martix display loop show: %1',
        MatrixDisplay_IMAGE: 'Martix-Anzeigebild %1'
    });
    Object.assign(Blockly.ScratchMsgs.locales['es'], {
        ...
        MATRIXDISPLAY_CATEGORY: 'Visualización de matriz',
        MatrixDisplay_INIT: 'iniciar pantalla de matriz %1',
        MatrixDisplay_DISPLAY: 'matriz %1 pantalla%2',
        MatrixDisplay_DRAWPIXEL: 'píxel de dibujo de pantalla Martix x: %1 y: %2',
        MatrixDisplay_COLOR_RED: 'rojo',
        MatrixDisplay_COLOR_BLACK: 'negro',
        MatrixDisplay_DRAWLINE: ' línea de dibujo de pantalla Martix x0: %1 y0: %2, x1: %3 y1: %4',
        MatrixDisplay_DRAWRECTANGLE: 'martix muestra dibujar rectángulo x: %1 y: %2 :ancho %3 largo: %4',
        MatrixDisplay_DRAWCIRCLE: 'martix muestra dibujar círculo x: %1 y: %2 :radio %3 ',
        MatrixDisplay_SHOWCHAR: ' martix muestra mostrar carácter o número: %1',
        MatrixDisplay_SHOW_LOOP: ' espectáculo de bucle de visualización Martix: %1',
        MatrixDisplay_IMAGE: 'imagen de visualización de Martix %1'
    });
    Object.assign(Blockly.ScratchMsgs.locales['fr'], {
         ...
         MATRIXDISPLAY_CATEGORY: 'Affichage matriciel',
         MatrixDisplay_INIT: 'affichage de la matrice d"initialisation %1',
         MatrixDisplay_DISPLAY: 'matrice %1 display%2',
         MatrixDisplay_DRAWPIXEL: ' affichage martix dessiner pixel x : %1 y : %2',
         MatrixDisplay_COLOR_RED: 'rouge',
         MatrixDisplay_COLOR_BLACK: 'noir',
         MatrixDisplay_DRAWLINE: ' affichage martix dessiner une ligne x0: %1 y0: %2, x1: %3 y1: %4',
         MatrixDisplay_DRAWRECTANGLE: 'martix display draw rectangle x: %1 y: %2 :width %3 length: %4',
         MatrixDisplay_DRAWCIRCLE: 'affichage martix dessine cercle x: %1 y: %2 :rayon %3 ',
         MatrixDisplay_SHOWCHAR: 'affichage martix afficher le caractère ou le nombre: %1',
         MatrixDisplay_SHOW_LOOP: 'affichage de la boucle d"affichage martix: %1',
         MatrixDisplay_IMAGE: 'image d"affichage martix %1'
    });
    Object.assign(Blockly.ScratchMsgs.locales['ja'], {
        KS_VARIABLE_LABEL:'変数タイプ',
         ...
         MATRIXDISPLAY_CATEGORY: ' マトリックス表示',
         MatrixDisplay_INIT: '行列表示の初期化 %1',
         MatrixDisplay_DISPLAY: 'マトリックス %1 表示%2',
         MatrixDisplay_DRAWPIXEL: ' martix 表示描画ピクセル x: %1 y: %2',
         MatrixDisplay_COLOR_RED: '赤',
         MatrixDisplay_COLOR_BLACK: '黒',
         MatrixDisplay_DRAWLINE: ' マトリックス表示描画線 x0: %1 y0: %2, x1: %3 y1: %4',
         MatrixDisplay_DRAWRECTANGLE: 'martix 表示描画四角形 x: %1 y: %2 :幅 %3 長さ: %4',
         MatrixDisplay_DRAWCIRCLE: 'マトリックス表示描画円 x: %1 y: %2 :半径 %3 ',
         MatrixDisplay_SHOWCHAR: ' martix 表示は文字または数値を表示します: %1',
         MatrixDisplay_SHOW_LOOP: ' martix 表示ループ表示 : %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ko'], {
        KS_VARIABLE_LABEL:'변수 유형',
         ...
         MATRIXDISPLAY_CATEGORY: ' 매트릭스 디스플레이',
         MatrixDisplay_INIT: '매트릭스 디스플레이 %1 초기화',
         MatrixDisplay_DISPLAY: '매트릭스 %1 디스플레이%2',
         MatrixDisplay_DRAWPIXEL: ' martix 디스플레이 그리기 픽셀 x: %1 y: %2',
         MatrixDisplay_COLOR_RED: '빨간색',
         MatrixDisplay_COLOR_BLACK: '검은색',
         MatrixDisplay_DRAWLINE: ' martix 디스플레이 그리기 선 x0: %1 y0: %2, x1: %3 y1: %4',
         MatrixDisplay_DRAWRECTANGLE: 'martix 디스플레이 그리기 사각형 x: %1 y: %2 :너비 %3 길이: %4',
         MatrixDisplay_DRAWCIRCLE: 'martix 디스플레이 그리기 원 x: %1 y: %2 :반지름 %3 ',
         MatrixDisplay_SHOWCHAR: ' martix 디스플레이 표시 문자 또는 숫자: %1',
         MatrixDisplay_SHOW_LOOP: ' martix 디스플레이 루프 쇼: %1',
         MatrixDisplay_IMAGE: ' martix 디스플레이 이미지 %1'
    });
    Object.assign(Blockly.ScratchMsgs.locales['pl'], {
        ...
        MATRIXDISPLAY_CATEGORY: 'Wyświetlanie matrycy',
        MatrixDisplay_INIT: 'wyświetlanie matrycy początkowej %1',
        MatrixDisplay_DISPLAY: 'macierz %1 wyświetlacz%2',
        MatrixDisplay_DRAWPIXEL: 'wyświetlacz martix rysuje piksel x: %1 y: %2',
        MatrixDisplay_COLOR_RED: 'czerwony',
        MatrixDisplay_COLOR_BLACK: 'czarny',
        MatrixDisplay_DRAWLINE: ' martix wyświetla linię rysowania x0: %1 y0: %2, x1: %3 y1: %4',
        MatrixDisplay_DRAWRECTANGLE: 'wyświetlacz martix rysuje prostokąt x: %1 y: %2 :szerokość %3 długość: %4',
        MatrixDisplay_DRAWCIRCLE: 'martix display rysuje okrąg x: %1 y: %2:promień %3',
        MatrixDisplay_SHOWCHAR: 'wyświetlacz martix pokazuje znak lub numer: %1',
        MatrixDisplay_SHOW_LOOP: 'pokaz pętli wyświetlacza martix: %1',
        MatrixDisplay_IMAGE: 'martix wyświetla obraz %1'
    });
    Object.assign(Blockly.ScratchMsgs.locales['pt'], {
        KS_VARIABLE_LABEL:'Tipo de variável',
         ...
         MATRIXDISPLAY_CATEGORY: 'Exibição de matriz',
         MatrixDisplay_INIT: 'inicializar exibição de matriz %1',
         MatrixDisplay_DISPLAY: 'matriz %1 display%2',
         MatrixDisplay_DRAWPIXEL: ' martix display desenha pixel x: %1 y: %2',
         MatrixDisplay_COLOR_RED: 'vermelho',
         MatrixDisplay_COLOR_BLACK: 'preto',
         MatrixDisplay_DRAWLINE: 'martix display draw line x0: %1 y0: %2, x1: %3 y1: %4',
         MatrixDisplay_DRAWRECTANGLE: 'martix display desenhar retângulo x: %1 y: %2 :largura %3 comprimento: %4',
         MatrixDisplay_DRAWCIRCLE: 'martix display desenha círculo x: %1 y: %2 :radius %3 ',
         MatrixDisplay_SHOWCHAR: 'exibição martix mostra caractere ou número: %1',
         MatrixDisplay_SHOW_LOOP: ' martix display loop show: %1',
         MatrixDisplay_IMAGE: ' imagem de exibição martix %1'
    });
    Object.assign(Blockly.ScratchMsgs.locales['ru'], {
        KS_VARIABLE_LABEL: 'Тип переменной',
         ...
         MATRIXDISPLAY_CATEGORY: 'Матричный дисплей',
         MatrixDisplay_INIT: 'инициализировать отображение матрицы %1',
         MatrixDisplay_DISPLAY: 'матрица %1 дисплей%2',
         MatrixDisplay_DRAWPIXEL: 'пиксель отрисовки дисплея martix x: %1 y: %2',
         MatrixDisplay_COLOR_RED: 'красный',
         MatrixDisplay_COLOR_BLACK: 'черный',
         MatrixDisplay_DRAWLINE: 'линия рисования martix display x0: %1 y0: %2, x1: %3 y1: %4',
         MatrixDisplay_DRAWRECTANGLE: 'прямоугольник рисования martix display x: %1 y: %2 :width %3 length: %4',
         MatrixDisplay_DRAWCIRCLE: 'martix display draw circle x: %1 y: %2 :radius %3 ',
         MatrixDisplay_SHOWCHAR: ' martix display show char or number: %1',
         MatrixDisplay_SHOW_LOOP: 'показ цикла отображения martix: %1',
         MatrixDisplay_IMAGE: 'отображаемое изображение martix %1'
    });
    Object.assign(Blockly.ScratchMsgs.locales['zh-tw'], {
        ...
        MatrixDisplay_DISPLAY: '點陣屏 %1 顯示%2',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['zh-cn'], {
        ...
        MatrixDisplay_DISPLAY: '点阵屏 %1 显示%2',
