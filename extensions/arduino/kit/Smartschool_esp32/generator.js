...
//Infrared
Blockly.Arduino.infrared_readValue = function(block) {
    var arg0 = block.getFieldValue('pin');
    var code = "digitalRead(" + arg0 + ")";
    Blockly.Arduino.setups_.pir_init = `pinMode(${arg0}, INPUT);`;
...
Blockly.Arduino.ens160_read = function (block) {  
    Blockly.Arduino.includes_.include_ens160_init = `#include <ENS160.h>\n#include <Wire.h>`;
    Blockly.Arduino.definitions_[`ens160_1`] = `ENS160 myENS;`;
    ...
    Blockly.Arduino.loops_['ens160_2'] = `myENS.checkDataStatus();`;  
