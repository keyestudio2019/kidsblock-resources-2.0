...
public:
  ...
  //NeoPixel(uint8_t p=6, uint16_t n=4, uint8_t bright = 255, neoPixelType t=NEO_GRB + NEO_KHZ800);
  NeoPixel(void);
  ~NeoPixel();
  ...
  begin(uint8_t p = 6, uint16_t n = 4, uint8_t bright = 255, neoPixelType t = NEO_GRB + NEO_KHZ800),
      show(void),
      setPin(uint8_t p),
      setPixelColor(uint16_t n, uint8_t g, uint8_t r, uint8_t b),
      setPixelColor(uint16_t n, uint8_t g, uint8_t r, uint8_t b, uint8_t w),
