...
function addMsg (Blockly) {
    Object.assign(Blockly.ScratchMsgs.locales.en, {
        ...
        MATIRXDISPLAY_SCROLLSHOW: 'martix display loop show %1 speed %2 ',
        MATIRXDISPLAY_FACE: 'Martix display image %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['de'], {
        ...
        MATIRXDISPLAY_CATEGORY: 'Matrix',
        MATIRXDISPLAY_INIT: 'Matrixanzeige DIN io23 CLK io18 Pin CS %1 initieren',
        MATIRXDISPLAY_INIT_TOOLTIP: 'Pin an MOSI und CLK an SCK.',
        MATIRXDISPLAY_DRAWPIXEL: 'martix display draw pixel x: %1 y: %2 color %3',
        MATIRXDISPLAY_COLOR_RED: 'rot',
        MATIRXDISPLAY_COLOR_BLACK: 'schwarz',
        MATIRXDISPLAY_DRAWLINE: 'martix display line x0: %1 y0: %2, x1: %3 y1: %4 color %5',
        MATIRXDISPLAY_SHOWCHAR: 'martix display show char %1 color %2',
        MATIRXDISPLAY_SHOWNUMBER: 'martix display show number %1 color %2',
        MATIRXDISPLAY_SCROLLSHOW: 'Martix-Anzeigeschleife zeigt %1 Geschwindigkeit %2 ',
        MATIRXDISPLAY_FACE: 'Martix zeigt Bild %1 an',
        MATIRXDISPLAY_FILL: 'Martix-Anzeigefüllfarbe %1',
        MATIRXDISPLAY_REFRESH: 'Anzeige der Martix-Anzeige aktualisieren',
        MATIRXDISPLAY_SETBRIGHTNESS: 'Martix-Anzeige stellt Helligkeit %1 ein',
        MATIRXDISPLAY_SETROTATION: 'Martix-Anzeigesatzrotation %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['es'], {
        ...
        MATIRXDISPLAY_DRAWPIXEL: 'píxel de dibujo de pantalla martix x: %1 y: %2 color %3',
        MATIRXDISPLAY_COLOR_RED: 'rojo',
        MATIRXDISPLAY_COLOR_BLACK: 'negro',
        MATIRXDISPLAY_DRAWLINE: 'línea de dibujo de pantalla martix x0: %1 y0: %2, x1: %3 y1: %4 color %5',
        MATIRXDISPLAY_SHOWCHAR: 'martix display show char %1 color %2',
        MATIRXDISPLAY_SHOWNUMBER: 'martix display mostrar número %1 color %2',
        MATIRXDISPLAY_SCROLLSHOW: 'martix display loop muestra %1 velocidad %2 ',
        MATIRXDISPLAY_FACE: 'Imagen de visualización de Martix %1',
        MATIRXDISPLAY_FILL: 'color de relleno de pantalla martix %1',
        MATIRXDISPLAY_REFRESH: 'actualizar la pantalla de martix display',
        MATIRXDISPLAY_SETBRIGHTNESS: 'brillo de conjunto de pantalla martix %1',
        MATIRXDISPLAY_SETROTATION: 'rotación del conjunto de visualización martix %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['fr'], {
        KS_VARIABLE_LABEL:'Type de variable',
         ...
         MATIRXDISPLAY_DRAWPIXEL: 'affichage martix dessiner pixel x: %1 y: %2 couleur %3',
         MATIRXDISPLAY_COLOR_RED: 'rouge',
         MATIRXDISPLAY_COLOR_BLACK: 'noir',
         MATIRXDISPLAY_DRAWLINE: 'martix display draw line x0: %1 y0: %2, x1: %3 y1: %4 color %5',
         MATIRXDISPLAY_SHOWCHAR: 'affichage martix affiche le caractère %1 couleur %2',
         MATIRXDISPLAY_SHOWNUMBER: 'affichage martix affiche le numéro %1 couleur %2',
         MATIRXDISPLAY_SCROLLSHOW: 'la boucle d"affichage martix affiche %1 vitesse %2 ',
         MATIRXDISPLAY_FACE: 'Image d"affichage Martix %1',
         MATIRXDISPLAY_FILL: 'couleur de remplissage d"affichage martix %1',
         MATIRXDISPLAY_REFRESH: 'rafraîchit l"affichage de l"affichage martix',
         MATIRXDISPLAY_SETBRIGHTNESS: 'l"affichage martix définit la luminosité %1',
         MATIRXDISPLAY_SETROTATION: 'affichage martix défini la rotation %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ja'], {
        KS_VARIABLE_LABEL:'変数タイプ',
         ...
         MATIRXDISPLAY_DRAWPIXEL: 'martix 表示描画ピクセル x: %1 y: %2 カラー %3',
         MATIRXDISPLAY_COLOR_RED: '赤',
         MATIRXDISPLAY_COLOR_BLACK: '黒',
         MATIRXDISPLAY_DRAWLINE: 'martix 表示描画線 x0: %1 y0: %2, x1: %3 y1: %4 カラー %5',
         MATIRXDISPLAY_SHOWCHAR: 'martix 表示表示文字 %1 カラー %2',
         MATIRXDISPLAY_SHOWNUMBER: 'martix ディスプレイ表示番号 %1 カラー %2',
         MATIRXDISPLAY_SCROLLSHOW: 'martix 表示ループ表示 %1 速度 %2 ',
         MATIRXDISPLAY_FACE: 'Martix 表示イメージ %1',
         MATIRXDISPLAY_FILL: 'martix 表示塗りつぶし色 %1',
         MATIRXDISPLAY_REFRESH: 'Martix 表示の表示を更新します',
         MATIRXDISPLAY_SETBRIGHTNESS: 'martix ディスプレイ設定の明るさ %1',
         MATIRXDISPLAY_SETROTATION: 'martix 表示セットの回転 %1',
         IR_CATEGORY: 'IR リモコン',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ko'], {
        KS_VARIABLE_LABEL:'변수 유형',
         ...
         MATIRXDISPLAY_INIT: 'DIN io23 CLK io18 핀 CS %1 매트릭스 디스플레이 초기화',
         MATIRXDISPLAY_INIT_TOOLTIP: 'DIN을 MOSI에 고정하고 CLK를 SCK에 고정합니다.',
         MATIRXDISPLAY_DRAWPIXEL: 'martix 디스플레이 그리기 픽셀 x: %1 y: %2 색상 %3',
         MATIRXDISPLAY_COLOR_RED: '빨간색',
         MATIRXDISPLAY_COLOR_BLACK: '검은색',
         MATIRXDISPLAY_DRAWLINE: 'martix 디스플레이 그리기 선 x0: %1 y0: %2, x1: %3 y1: %4 색상 %5',
         MATIRXDISPLAY_SHOWCHAR: 'martix 표시 문자 %1 색상 %2',
         MATIRXDISPLAY_SHOWNUMBER: 'martix 디스플레이 쇼 번호 %1 색상 %2',
         MATIRXDISPLAY_SCROLLSHOW: 'martix 디스플레이 루프 쇼 %1 속도 %2',
         MATIRXDISPLAY_FACE: 'Martix 디스플레이 이미지 %1',
         MATIRXDISPLAY_FILL: 'martix 디스플레이 채우기 색상 %1',
         MATIRXDISPLAY_REFRESH: 'martix 디스플레이 새로 고침',
         MATIRXDISPLAY_SETBRIGHTNESS: 'martix 디스플레이 설정 밝기 %1',
         MATIRXDISPLAY_SETROTATION: 'martix 디스플레이 세트 회전 %1',
         IR_CATEGORY: 'IR 리모트',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['pl'], {
        ...
        MATIRXDISPLAY_INIT: 'początkowa matryca wyświetlania DIN io23 CLK io18 pin CS %1',
        MATIRXDISPLAY_INIT_TOOLTIP: 'przypnij DIN do MOSI i CLK do SCK.',
        MATIRXDISPLAY_DRAWPIXEL: 'wyświetlacz martix rysuje piksel x: %1 y: %2 kolor %3',
        MATIRXDISPLAY_COLOR_RED: 'czerwony',
        MATIRXDISPLAY_COLOR_BLACK: 'czarny',
        MATIRXDISPLAY_DRAWLINE: 'martix wyświetla linię rysowania x0: %1 y0: %2, x1: %3 y1: %4 kolor %5',
        MATIRXDISPLAY_SHOWCHAR: 'wyświetlacz martix pokazuje znak %1 kolor %2',
        MATIRXDISPLAY_SHOWNUMBER: 'wyświetlacz martix pokazuje numer %1 kolor %2',
        MATIRXDISPLAY_SCROLLSHOW: 'pętla wyświetlacza martix pokazuje %1 prędkość %2',
        MATIRXDISPLAY_FACE: 'Martix wyświetla obraz %1',
        MATIRXDISPLAY_FILL: 'kolor wypełnienia wyświetlacza martix %1',
        MATIRXDISPLAY_REFRESH: 'odśwież widok wyświetlacza martix',
        MATIRXDISPLAY_SETBRIGHTNESS: 'wyświetlacz martix ustawia jasność %1',
        MATIRXDISPLAY_SETROTATION: 'obrót zestawu wyświetlania martix %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['pt'], {
        KS_VARIABLE_LABEL:'Tipo de variável',
         ...
         MATIRXDISPLAY_CATEGORY: 'Matriz',
         MATIRXDISPLAY_INIT: 'exibição da matriz de inicialização DIN io23 CLK io18 pin CS %1',
         MATIRXDISPLAY_INIT_TOOLTIP: 'pino DIN para MOSI e CLK para SCK.',
         MATIRXDISPLAY_DRAWPIXEL: 'martix display desenha pixel x: %1 y: %2 cor %3',
         MATIRXDISPLAY_COLOR_RED: 'vermelho',
         MATIRXDISPLAY_COLOR_BLACK: 'preto',
         MATIRXDISPLAY_DRAWLINE: 'martix exibir linha de desenho x0: %1 y0: %2, x1: %3 y1: %4 cor %5',
         MATIRXDISPLAY_SHOWCHAR: 'martix display show char %1 color %2',
         MATIRXDISPLAY_SHOWNUMBER: 'exibição martix mostra número %1 cor %2',
         MATIRXDISPLAY_SCROLLSHOW: 'martix display loop mostra %1 velocidade %2 ',
         MATIRXDISPLAY_FACE: 'Imagem de exibição Martix %1',
         MATIRXDISPLAY_FILL: 'martix exibir cor de preenchimento %1',
         MATIRXDISPLAY_REFRESH: 'atualizar a exibição do display martix',
         MATIRXDISPLAY_SETBRIGHTNESS: 'martix display set brilho %1',
         MATIRXDISPLAY_SETROTATION: 'rotação do conjunto de exibição martix %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ru'], {
        KS_VARIABLE_LABEL: 'Тип переменной',
         ...
         MATIRXDISPLAY_INIT: 'инициализировать матричный дисплей DIN io23 CLK io18 pin CS %1',
         ...
         MATIRXDISPLAY_DRAWLINE: 'линия рисования martix display x0: %1 y0: %2, x1: %3 y1: %4 color %5',
         MATIRXDISPLAY_SHOWCHAR: 'martix display show char %1 color %2',
         MATIRXDISPLAY_SHOWNUMBER: 'количество показов дисплея martix %1, цвет %2',
         MATIRXDISPLAY_SCCROLLSHOW: 'цикл дисплея martix показывает %1 скорость %2 ',
         MATIRXDISPLAY_FACE: 'Изображение дисплея Martix %1',
         MATIRXDISPLAY_FILL: 'цвет заливки дисплея martix %1',
         MATIRXDISPLAY_REFRESH: 'обновить отображение martix display',
         MATIRXDISPLAY_SETBRIGHTNESS: 'яркость дисплея martix установлена %1',
         MATIRXDISPLAY_SETROTATION: 'поворот дисплея martix установлен на %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['zh-tw'], {
        ...
        MATIRXDISPLAY_INIT: '初始化點陣屏DIN io23 CLK io18 引腳 CS %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['zh-cn'], {
        ...
        MATIRXDISPLAY_INIT: '初始化点阵屏DIN io23 CLK io18 引脚 CS %1',
