...
function addMsg (Blockly) {
    ...
    Object.assign(Blockly.ScratchMsgs.locales['de'], {
        ...
        VOLTAGE_CATEGORY: 'Spannung',
        VOLTAGE_READ_VALUE: 'den Wert der Spannung %1 lesen',
        CURRENT_CATEGORY: 'aktuell',
        CURRENT_READ_VALUE: 'den Wert von aktuell %1 lesen',
        ...
        SD_INIT: 'SD-Karten-CS initialisieren: %1',
        SD_TYPE: 'SD-Typ cs# %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['es'], {
        ...
        VOLTAGE_CATEGORY: 'voltaje',
        VOLTAGE_READ_VALUE: 'leer el valor del voltaje %1',
        CATEGORÍA_ACTUAL: 'actual',
        CURRENT_READ_VALUE: 'leer el valor del %1 actual',
        ...
        SD_INIT: 'iniciar tarjeta SD CS: %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['fr'], {
        KS_VARIABLE_LABEL:'Type de variable',
         ...
         VOLTAGE_CATEGORY: 'tension',
         VOLTAGE_READ_VALUE: 'lire la valeur de la tension %1',
         CURRENT_CATEGORY: 'actuel',
         CURRENT_READ_VALUE: 'lire la valeur actuelle de %1',
         ...
         SD_INIT: 'initialisation de la carte SD: %1',
         SD_TYPE: 'SD type cs# %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ja'], {
        KS_VARIABLE_LABEL:'変数タイプ',
         ...
         VOLTAGE_CATEGORY: '電圧',
         VOLTAGE_READ_VALUE: '電圧 %1 の値を読み取ります',
         CURRENT_CATEGORY: '現在',
         CURRENT_READ_VALUE: '現在の %1 の値を読み取ります',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ko'], {
        KS_VARIABLE_LABEL:'변수 유형',
         ...
         VOLTAGE_CATEGORY: '전압',
         VOLTAGE_READ_VALUE: '%1 전압 값 읽기',
         CURRENT_CATEGORY: '현재',
         CURRENT_READ_VALUE: '현재 %1의 값 읽기',
         MPU6050_CATEGORY: '가속',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['pl'], {
        ...
        VOLTAGE_CATEGORY: 'napięcie',
        VOLTAGE_READ_VALUE: 'odczytaj wartość napięcia %1',
        CURRENT_CATEGORY: 'aktualna',
        CURRENT_READ_VALUE: 'odczytaj wartość bieżącego %1',
        ...
        SD_INIT: 'początkowa karta SD CS: %1',
        SD_TYPE: 'SD typ cs# %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['pt'], {
        KS_VARIABLE_LABEL:'Tipo de variável',
         ...
         VOLTAGE_CATEGORY: 'tensão',
         VOLTAGE_READ_VALUE: 'lê o valor da tensão %1',
         CURRENT_CATEGORY: 'atual',
         CURRENT_READ_VALUE: 'ler o valor do %1 atual',
         ...
         SD_INIT: 'iniciar cartão SD CS: %1',
         SD_TYPE: 'SD tipo cs# %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ru'], {
        KS_VARIABLE_LABEL: 'Тип переменной',
         ...
         VOLTAGE_CATEGORY: 'напряжение',
         VOLTAGE_READ_VALUE: 'прочитать значение напряжения %1',
         CURRENT_CATEGORY: 'текущая',
         CURRENT_READ_VALUE: 'прочитать значение текущего %1',
         ...
         SD_INIT: 'инициализировать SD-карту CS: %1',
         SD_TYPE: 'Тип SD cs# %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['zh-tw'], {
        ...
        VOLTAGE_CATEGORY: '電壓',
        VOLTAGE_READ_VALUE: '讀取接口 %1 電壓',
        CURRENT_CATEGORY: '電流',
        CURRENT_READ_VALUE: '讀取接口 %1 電流',
        MPU6050_CATEGORY: '加速度',
