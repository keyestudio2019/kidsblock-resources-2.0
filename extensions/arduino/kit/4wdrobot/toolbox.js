...
<category name="%{BKY_SINGLEPROBE_CATEGORY}" id="SINGLEPROBE_CATEGORY" colour="#7700FF" secondaryColour="#7700FF">
...
<category name="%{BKY_MOTOR130_CATEGORY}" id="MOTOR130_CATEGORY" colour="#42CCFF" secondaryColour="#42CCFF">
...
<category name="%{BKY_KS_SERVO_CATEGORY}" id="KS_SERVO_CATEGORY" colour="#FF3399" secondaryColour="#FF3399">
...
<category name="%{BKY_IR_CATEGORY}" id="IR_CATEGORY" colour="#228b22" secondaryColour="#228b22">
