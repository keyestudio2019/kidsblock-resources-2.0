...
function addMsg (Blockly) {
    Object.assign(Blockly.ScratchMsgs.locales.en, {
        ...
        MATRIX8_16_INIT: 'Init  Matrix 8*16 SDA%1 SCL%2',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['de'], {
        ...
        SINGLEPROBE_CATEGORY: 'Linienverfolgung',
        SINGLEPROBE_READ_STATE: 'Leitungsverfolgungs-PIN %1 Weiß wurde erkannt?',
        SINGLEPROBE_READ_VALUE: 'Der Statuswert der Leitungsverfolgungs-PIN %1 ist ?',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['es'], {
        ...
        SINGLEPROBE_CATEGORY: 'Seguimiento de línea',
        SINGLEPROBE_READ_STATE: '¿Se detectó el PIN de seguimiento de línea %1 blanco?',
        SINGLEPROBE_READ_VALUE: '¿El valor de estado del PIN de seguimiento de línea %1 es ?',
        ...
        HC_SR04_READ_DISTANCE: 'Pin de disparo %1 pin de eco %2 distancia de lectura %3',
        ...
        MATRIX8_16_INIT: 'Iniciar Matriz  8*16 SDA%1 SCL%2',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['fr'], {
        KS_VARIABLE_LABEL:'Type de variable',
         ...
         SINGLEPROBE_CATEGORY: 'Suivi de ligne',
         SINGLEPROBE_READ_STATE: 'Le code PIN de suivi de ligne %1 White a été détecté?',
         SINGLEPROBE_READ_VALUE: 'La valeur de l"état du code PIN de suivi de ligne %1 est?',
         ...
         MATRIX8_16_INIT: 'Init  Matrice 8*16 SDA%1 SCL%2',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ja'], {
        KS_VARIABLE_LABEL:'変数タイプ',
         ...
         SINGLEPROBE_CATEGORY: 'ライン追跡',
         SINGLEPROBE_READ_STATE: 'ライン追跡PIN %1 ホワイトが検出されました?',
         SINGLEPROBE_READ_VALUE: 'ライン追跡PIN %1の状態値は?',
         ...
         MATRIX8_16_INIT: ' マトリックス 8*16 SDA%1 SCL%2 を初期化',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ko'], {
        KS_VARIABLE_LABEL:'변수 유형',
         ...
         SINGLEPROBE_CATEGORY: '라인 트래킹',
         SINGLEPROBE_READ_STATE: '라인 추적 PIN %1 흰색이 감지되었습니까?',
         SINGLEPROBE_READ_VALUE: '라인 추적 PIN %1 상태 값은 ?',
         ...
         HC_SR04_READ_DISTANCE: '트리거 핀 %1 에코 핀 %2 읽기 거리 %3',
         IR_CATEGORY: 'IR 리모트',
         ...
         MATRIX8_16_INIT: ' 매트릭스 8*16 SDA%1 SCL%2 초기화',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['pl'], {
        ...
        SINGLEPROBE_CATEGORY: 'Śledzenie linii',
        SINGLEPROBE_READ_STATE: 'PIN śledzenia linii %1 Biały został wykryty?',
        SINGLEPROBE_READ_VALUE: 'Wartość stanu %1 śledzenia linii wynosi?',
        ...
        HC_SR04_READ_DISTANCE: 'Styk wyzwalający %1 pin echa %2 odległość odczytu %3',
        ...
        MATRIX8_16_INIT: 'Inicjacja Matryca  8*16 SDA%1 SCL%2',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['pt'], {
        KS_VARIABLE_LABEL:'Tipo de variável',
         ...
         SINGLEPROBE_CATEGORY: 'Rastreamento de linha',
         SINGLEPROBE_READ_STATE: 'PIN de rastreamento de linha %1 branco foi detectado?',
         SINGLEPROBE_READ_VALUE: 'O valor do estado %1 do PIN de rastreamento de linha é ?',
         ...
         HC_SR04_READ_DISTANCE: 'Trig pin %1 echo pin %2 distância de leitura %3',
         ...
         MATRIX8_16_CATEGORY: 'Matriz 8*16',
         MATRIX8_16_INIT: 'Iniciar  Matrix 8*16 SDA%1 SCL%2',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ru'], {
        KS_VARIABLE_LABEL: 'Тип переменной',
         ...
         SINGLEPROBE_CATEGORY: 'Отслеживание линии',
         SINGLEPROBE_READ_STATE: 'Обнаружен PIN-код отслеживания линии %1 белого цвета?',
         SINGLEPROBE_READ_VALUE: 'Значение состояния ПИН-кода отслеживания линии %1 равно?',
         ...
         MATRIX8_16_INIT: 'Инициировать Матрица  8*16 SDA%1 SCL%2',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['zh-tw'], {
        ...
        SINGLEPROBE_CATEGORY: '巡線傳感器',
        SINGLEPROBE_READ_STATE: '接口%1巡線傳感器檢測到白色?',
        SINGLEPROBE_READ_VALUE: '接口%1巡線傳感器的狀態值',
        ...
        MATRIX8_16_INIT: '初始化 點陣 8*16  SDA%1 SCL%2',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['zh-cn'], {
        ...
        MATRIX8_16_INIT: '初始化 点阵屏  SDA%1 SCL%2',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['it'], {
        ...
        ROBOT_FORWARD: 'Auto avanti con velocità %1',
        ROBOT_BACK: 'Auto indietro con velocità %1',
        ROBOT_LEFT: 'Auto gira a sinistra con velocità %1',
        ROBOT_RIGHT: 'Auto gira a destra con velocità %1',
        ROBOT_STOP: 'Auto fermata',
        LED_CATEGORY: 'LED',
        LED_SET_LED_STATE: 'LED interfaccia %1 stato %2',
        LED_ON: 'Accendi',
        LED_OFF: 'Spegni',
        LED_ANALOG: 'LED %1 uscita analogica %2',
        SINGLEPROBE_CATEGORY: 'Sensore di linea',
        SINGLEPROBE_READ_STATE: 'Sensore di linea su interfaccia %1 rileva bianco?',
        SINGLEPROBE_READ_VALUE: 'Valore stato sensore di linea su interfaccia %1',
        MOTOR130_CATEGORY: 'Motore DC',
        MOTOR130_DIGITAL: 'Motore driver INA#%1 stato %2 INB#%3 stato %4',
        MOTOR130_ANALOG: 'Motore driver INA#%1 stato %2 INB#%3 valore di uscita analogico %4',
        KS_SERVO_CATEGORY: 'Servo',
        KS_SERVO_ANGLE: 'Servo pin %1 angolo %2 ritardo (ms) %3',
        KS_SERVO_READ: 'Servo pin %1 leggi angolo',
        HC_SR04_CATEGORY: 'Sensore a ultrasuoni',
        ...
        MATRIX8_16_CATEGORY: 'Display matrice 8*16',
        MATRIX8_16_INIT: 'Inizializza display matrice SDA %1 SCL %2',
        MATRIX8_16_DISPLAY: 'Display matrice %1 mostra %2 gruppo %3 nome %4',
        MATRIX8_16_FACE: 'Matrice mostra %1',
        MATRIX8_16_PIEXL: 'Matrice mostra punto X %1 Y %2 livello %3',
        MATRIX8_16_REFRESH: 'Matrice aggiorna display',
