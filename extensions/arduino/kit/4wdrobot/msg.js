...
function addMsg (Blockly) {
    ...
    Object.assign(Blockly.ScratchMsgs.locales['de'], {
        ...
        MATRIX8_16_CATEGORY: 'Matrix',
        MATRIX8_16_INIT: 'Matrix SDA%1 SCL%2 initialisieren',
        ...
        MATRIX8_16_REFRESH: 'Matrix aktualisieren',
        MATRIX8_16_CLEAR: 'Matrix löschen',
    });
    ...
    Object.assign(Blockly.ScratchMsgs.locales['fr'], {
        KS_VARIABLE_LABEL:'Type de variable',
         ...
         MATRIX8_16_INIT: 'Init Matrice SDA%1 SCL%2',
         MATRIX8_16_DISPLAY: 'Matrice8*16 %1 affichage%2',
         MATRIX8_16_FACE: 'Visage d"affichage de la matrice%1',
         MATRIX8_16_PIEXL: 'Matrice Axe X%1 Axe Y%2 État%3',
         MATRIX8_16_REFRESH: 'Rafraîchissement de la matrice',
         MATRIX8_16_CLEAR: 'Matrice claire',
    });
    Object.assign(Blockly.ScratchMsgs.locales['ja'], {
        KS_VARIABLE_LABEL:'変数タイプ',
         ...
         MATRIX8_16_INIT: 'マトリックスの初期化 SDA%1 SCL%2',
         MATRIX8_16_DISPLAY: 'Matrix8*16 %1 表示%2',
         MATRIX8_16_FACE: 'マトリックス表示面%1',
         MATRIX8_16_PIEXL: 'マトリックス X 軸%1 Y 軸%2 状態%3',
         MATRIX8_16_REFRESH: 'マトリックスを更新',
         MATRIX8_16_CLEAR: 'マトリックスクリア',
    });
    Object.assign(Blockly.ScratchMsgs.locales['ko'], {
        KS_VARIABLE_LABEL:'변수 유형',
         ...
         MATRIX8_16_INIT: '매트릭스 SDA%1 SCL%2 초기화',
         MATRIX8_16_DISPLAY: '매트릭스8*16 %1 디스플레이%2',
         MATRIX8_16_FACE: '매트릭스 표시면%1',
         MATRIX8_16_PIEXL: '행렬 X 축%1 Y 축%2 상태%3',
         MATRIX8_16_REFRESH: '매트릭스 새로 고침',
         MATRIX8_16_CLEAR: '행렬 지우기',
    });
    Object.assign(Blockly.ScratchMsgs.locales['pl'], {
        ...
        MATRIX8_16_INIT: 'Macierz inicjująca SDA%1 SCL%2',
        MATRIX8_16_DISPLAY: 'Matryca8*16 %1 wyświetlacz%2',
        MATRIX8_16_FACE: 'Matrix display face%1',
        MATRIX8_16_PIEXL: 'Matryca Oś X%1 Oś Y%2 Stan%3',
        MATRIX8_16_REFRESH: 'Odświeżanie macierzy',
        MATRIX8_16_CLEAR: 'Matryca wyczyść',
    });
    Object.assign(Blockly.ScratchMsgs.locales['pt'], {
        KS_VARIABLE_LABEL:'Tipo de variável',
         ...
         MATRIX8_16_INIT: 'Iniciar Matriz SDA%1 SCL%2',
         MATRIX8_16_DISPLAY: 'Matrix8*16 %1 display%2',
         MATRIX8_16_FACE: 'Face de exibição da matriz%1',
         MATRIX8_16_PIEXL: 'Matriz Eixo X%1 Eixo Y%2 Estado%3',
         MATRIX8_16_REFRESH: 'Atualização da matriz',
         MATRIX8_16_CLEAR: 'Matriz limpa',
    });
    Object.assign(Blockly.ScratchMsgs.locales['ru'], {
        KS_VARIABLE_LABEL: 'Тип переменной',
         ...
         MATRIX8_16_INIT: 'Инициализировать матрицу SDA%1 SCL%2',
         MATRIX8_16_DISPLAY: 'Matrix8*16 %1 дисплей%2',
         MATRIX8_16_FACE: 'Матричное отображение лица%1',
         MATRIX8_16_PIEXL: 'Матрица Ось X%1 Ось Y%2 Состояние%3',
         MATRIX8_16_REFRESH: 'Обновление матрицы',
         MATRIX8_16_CLEAR: 'Очистить матрицу',
    });
