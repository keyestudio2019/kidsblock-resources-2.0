...
function addMsg (Blockly) {
    Object.assign(Blockly.ScratchMsgs.locales.en, {
        ...
        ROBOT_FORWARD: "Robot moves forward  left motor speed %1 right motor speed %2",
        ROBOT_BACK: "Robot moves backward  left motor speed %1 right motor speed %2",
        ROBOT_LEFT: "Robot turns left left  motor speed %1 right motor speed %2",
        ROBOT_RIGHT: "Robot turns right  left motor speed %1 right motor speed %2",
    ...
    Object.assign(Blockly.ScratchMsgs.locales['de'], {
        ...
        KS_judge:'%1 %2 %3',
        ROBOT_CATEGORY: 'Roboter',  
        ROBOT_FORWARD: "Roboter fährt vorwärts, linke Motorleistung %1, rechte Motorleistung %2",  
        ROBOT_BACK: "Roboter fährt rückwärts, linke Motorleistung %1, rechte Motorleistung %2",  
        ROBOT_LEFT: "Roboter biegt links ab, linke Motorleistung %1, rechte Motorleistung %2",  
        ROBOT_RIGHT: "Roboter biegt rechts ab, linke Motorleistung %1, rechte Motorleistung %2",  
        ROBOT_STOP: "Roboter hält an"
    });
    Object.assign(Blockly.ScratchMsgs.locales['es'], {
        ...
        KS_judge:'%1 %2 %3',
        ROBOT_CATEGORY: 'El robot',
        ROBOT_FORWARD: "El robot avanza: velocidad del motor izquierdo %1, velocidad del motor derecho %2",
        ROBOT_BACK: "El robot retrocede: velocidad del motor izquierdo %1, velocidad del motor derecho %2",
        ROBOT_LEFT: "El robot gira a la izquierda: velocidad del motor izquierdo %1, velocidad del motor derecho %2",
        ROBOT_RIGHT: "El robot gira a la derecha: velocidad del motor izquierdo %1, velocidad del motor derecho %2",
        ROBOT_STOP: "El robot se detiene"
    });
    Object.assign(Blockly.ScratchMsgs.locales['fr'], {
        KS_VARIABLE_LABEL:'Type de variable',
         ...
         KS_judge:'%1 %2 %3',
         ROBOT_CATEGORY: 'Le robot',
         ROBOT_FORWARD: "Le robot avance Vitesse moteur gauche %1 vitesse moteur droit %2",
         ROBOT_BACK: "Le robot recule Vitesse moteur gauche %1 vitesse moteur droit %2",
         ROBOT_LEFT: "Le robot tourne à gauche Vitesse moteur gauche %1 vitesse moteur droit %2",
         ROBOT_RIGHT: "Le robot tourne à droite Vitesse moteur gauche %1 vitesse moteur droit %2",
         ROBOT_STOP: "Le robot s'arrête"
    });
    Object.assign(Blockly.ScratchMsgs.locales['ja'], {
        KS_VARIABLE_LABEL:'変数タイプ',
         ...
         KS_LOGIC_LABEL:'ロジック',
         KS_judge:'%1 %2 %3',
         ROBOT_CATEGORY: 'ロボットは',
         ROBOT_FORWARD: "ロボットは前進します 左モーターの速度 %1 右モーターの速度 %2",
         ROBOT_BACK: "ロボットは後退します 左モーターの速度 %1 右モーターの速度 %2",
         ROBOT_LEFT: "ロボットは左に曲がります 左モーターの速度 %1 右モーターの速度 %2",
         ROBOT_RIGHT: "ロボットは右に曲がります 左モーターの速度 %1 右モーターの速度 %2",
         ROBOT_STOP: "ロボットは停止します"
    });
    Object.assign(Blockly.ScratchMsgs.locales['ko'], {
        KS_VARIABLE_LABEL:'변수 유형',
         ...
         KS_LOGIC_LABEL:'논리',
         KS_judge:'%1 %2 %3',
         ROBOT_CATEGORY: '로봇 자동차',
         ROBOT_FORWARD: "로봇이 전진합니다 왼쪽 모터 속도 %1 오른쪽 모터 속도 %2",
         ROBOT_BACK: "로봇이 후진합니다 왼쪽 모터 속도 %1 오른쪽 모터 속도 %2",
    ...
    Object.assign(Blockly.ScratchMsgs.locales['pl'], {
        ...
        KS_judge:'%1%2%3',
        ROBOT_CATEGORY: 'Kategoria robota: samochód',  
        ...
        ROBOT_STOP: "Robot zatrzymuje się"  
    });
    Object.assign(Blockly.ScratchMsgs.locales['pt'], {
        KS_VARIABLE_LABEL:'Tipo de variável',
         ...
         KS_LOGIC_LABEL:'lógica',
         KS_judge:'%1 %2 %3',
         ROBOT_CATEGORY: 'O robô',
         ROBOT_FORWARD: "O robô avança com a velocidade do motor esquerdo %1 e a velocidade do motor direito %2",
         ROBOT_BACK: "O robô recua com a velocidade do motor esquerdo %1 e a velocidade do motor direito %2",
         ROBOT_LEFT: "O robô vira à esquerda com a velocidade do motor esquerdo %1 e a velocidade do motor direito %2",
         ROBOT_RIGHT: "O robô vira à direita com a velocidade do motor esquerdo %1 e a velocidade do motor direito %2",
         ROBOT_STOP: "O robô para"
    });
    Object.assign(Blockly.ScratchMsgs.locales['ru'], {
        KS_VARIABLE_LABEL: 'Тип переменной',
         ...
         KS_judge:'%1 %2 %3',
         ROBOT_CATEGORY: 'Робот',
         ROBOT_FORWARD: "Робот движется вперед левый двигатель скорость %1 правый двигатель скорость %2",
         ROBOT_BACK: "Робот движется назад левый двигатель скорость %1 правый двигатель скорость %2",
         ROBOT_LEFT: "Робот поворачивает налево левый двигатель скорость %1 правый двигатель скорость %2",
         ROBOT_RIGHT: "Робот поворачивает направо левый двигатель скорость %1 правый двигатель скорость %2",
         ROBOT_STOP: "Робот останавливается"
    });
    Object.assign(Blockly.ScratchMsgs.locales['zh-tw'], {
        ...
        KS_judge:'%1 %2 %3',
        ROBOT_CATEGORY: '智能車',
        ROBOT_FORWARD: "小車向前移動 左馬達速度 %1 右馬達速度 %2",
        ROBOT_BACK: "小車向後移動 左馬達速度 %1 右馬達速度 %2",
        ROBOT_LEFT: "小車向左轉動 左馬達速度 %1 右馬達速度 %2",
        ROBOT_RIGHT: "小車向右轉動 左馬達速度 %1 右馬達速度 %2",
        ROBOT_STOP: "小車停止"
    });
    ...
    Object.assign(Blockly.ScratchMsgs.locales['it'], {
        ...
        KS_judge: '%1 %2 %3',
        ROBOT_CATEGORY: 'Auto intelligente',
        ROBOT_FORWARD: 'Auto in avanti Velocità motore sinistro %1 velocità motore destro %2',
        ROBOT_BACK: 'Auto indietro Velocità motore sinistro %1 velocità motore destro %2',
        ROBOT_LEFT: 'Auto gira a sinistra Velocità motore sinistro %1 velocità motore destro %2',
        ROBOT_RIGHT: 'Auto gira a destra Velocità motore sinistro %1 velocità motore destro %2',
