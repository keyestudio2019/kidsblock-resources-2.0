...
Blockly.Arduino.robot_forward = function (block) {
    ...
    const val_L = Blockly.Arduino.valueToCode(block, 'SPEED_L', Blockly.Arduino.ORDER_ATOMIC);
    const val_R = Blockly.Arduino.valueToCode(block, 'SPEED_R', Blockly.Arduino.ORDER_ATOMIC);
