...
function addBlocks (Blockly) {
    ...
    const color8 = '#00bfff';
    const color9 = '#008000';
    const color10 = '#0000ff';
    const color11 = '#008080';
 ...
 // Motor
    Blockly.Blocks.motor130_left = {
        init: function () {
            this.jsonInit({
                message0: '%1',
                message1: Blockly.Msg.MOTOR130_LEFT,
                args0: [
                    {
                        type: 'field_image',
                        src: motorIconUrl,
    ...
    Blockly.Blocks.motor130_right = {
        init: function () {
            this.jsonInit({
                message0: '%1',
                message1: Blockly.Msg.MOTOR130_RIGHT,
                args0: [
                    {
                        type: 'field_image',
                        src: motorIconUrl,
