...
function addMsg (Blockly) {
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ja'], {
        KS_VARIABLE_LABEL:'変数タイプ',
         ...
         math_iic_DRAWLINE: 'Martix 描画ライン x0: %1 y0: %2, x1: %3 y1: %4',
         math_iic_DRAWRECTANGLE: 'Martix 描画長方形 x: %1 y: %2 :幅 %3 長さ: %4',
         行列_iic_DRAWCIRCLE: 'Martix 円を描く x: %1 y: %2 :半径 %3 ',
         行列_iic_SHOWCHAR: 'Martix 表示文字または数値: %1',
         行列_iic_SHOW_LOOP: 'Martix ループ表示: %1 速度: %2',
