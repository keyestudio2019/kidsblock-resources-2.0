...
function addBlocks (Blockly) {
    ...
    Blockly.Blocks.CUBE4_one = {
        init: function () {
            this.jsonInit({
                message0: '%1',
                message1: Blockly.Msg.CUBE4_ONE,
                args0: [
                    {
                        type: 'field_image',
                        src: CUBE4_IconUrl,
    ...
    Blockly.Blocks.CUBE4_effect = {
        init: function () {
            this.jsonInit({
                message0: '%1',
                message1: Blockly.Msg.CUBE4_EFFECT,
                args0: [
                    {
                        type: 'field_image',
                        src: CUBE4_IconUrl,
                ...
                args1: [
                    {
                        ...
                        name: 'EFFECT',
                        options: [
                            [Blockly.Msg.LAYERBOUNCE, 'LayerBounce'],
                            [Blockly.Msg.LAYEROTATE, 'LayerRotate'],
                            [Blockly.Msg.SPIRAL, 'Spiral'],
                            [Blockly.Msg.BORDERLOOP, 'BorderLoop'],
                            [Blockly.Msg.BORDERFLASH, 'BorderFlash'],
                            [Blockly.Msg.BORDERWIPE, 'BorderWipe'],
                            [Blockly.Msg.BLOCK4RANDOM, 'Block4Random'],
                            [Blockly.Msg.BALOCK4CORNERS, 'Block4Corners'],
                            [Blockly.Msg.RISE, 'Rise'],
                            [Blockly.Msg.FOURROTATE, 'FourRotate'],
                            [Blockly.Msg.SPIRALLAYERS, 'SpiralLayers'],
                            [Blockly.Msg.SNAKE, 'Snake'],
                            [Blockly.Msg.UPRIGHT, 'Upright'],
                            [Blockly.Msg.RANDOMFILL, 'RandomFill'],
                            [Blockly.Msg.CUBE, 'Cube']
                            ],
                    },
                    {
                        type: 'input_value',
    ...
    Blockly.Blocks.CUBE4_all_on = {
        init: function () {
            this.jsonInit({
                message0: '%1',
                message1: Blockly.Msg.CUBE4_ALL_ON,
                args0: [
                    {
                        type: 'field_image',
                        src: CUBE4_IconUrl,
    ...
    Blockly.Blocks.CUBE4_all_off = {
        init: function () {
            this.jsonInit({
                message0: '%1',
                message1: Blockly.Msg.CUBE4_ALL_OFF,
                args0: [
                    {
                        type: 'field_image',
                        src: CUBE4_IconUrl,
