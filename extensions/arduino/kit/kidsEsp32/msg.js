...
function addMsg (Blockly) {
    Object.assign(Blockly.ScratchMsgs.locales.en, {
        ...
        WIFI_READ_CONNECTED: 'WiFi read data',
        WIFI_READ_DATA: 'WiFi data',
        OLED_CATEGORY: 'OLED',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['de'], {
        ...
        WIFI_READ_CONNECTED: 'Wifi-Daten lesen',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['es'], {
        ...
        WIFI_READ_CONNECTED: 'Leer datos wifi',
        WIFI_READ_DATA: 'datos WiFi',
        CATEGORÍA_OLED: 'OLED',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['fr'], {
        KS_VARIABLE_LABEL:'Type de variable',
         ...
         WIFI_READ_CONNECTED: 'Lire les données wifi',
         WIFI_READ_DATA: 'données wifi',
         OLED_CATEGORY: 'OLED',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ja'], {
        KS_VARIABLE_LABEL:'変数タイプ',
         ...
         WIFI_READ_CONNECTED: '無線LANデータの読み取り',
         WIFI_READ_DATA: '無線LANデータ',
         OLED_CATEGORY: 'OLED',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ko'], {
        KS_VARIABLE_LABEL:'변수 유형',
         ...
         WIFI_READ_CONNECTED: 'Wi-Fi 데이터 읽기',
         WIFI_READ_DATA: 'Wi-Fi 데이터',
         OLED_CATEGORY: 'OLED',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['pl'], {
        ...
        WIFI_READ_CONNECTED: 'Odczyt danych wifi',
        WIFI_READ_DATA: 'dane wifi',
        OLED_CATEGORY: 'OLED',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['pt'], {
        KS_VARIABLE_LABEL:'Tipo de variável',
         ...
         WIFI_READ_CONNECTED: 'Ler dados wifi',
         WIFI_READ_DATA: 'dados wifi',
         OLED_CATEGORY: 'OLED',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ru'], {
        KS_VARIABLE_LABEL: 'Тип переменной',
         ...
         WIFI_READ_CONNECTED: 'Чтение данных wifi',
         WIFI_READ_DATA: 'данные Wi-Fi',
         OLED_CATEGORY: "OLED",
    ...
    Object.assign(Blockly.ScratchMsgs.locales['zh-tw'], {
        ...
        WIFI_READ_CONNECTED: '讀取WiFi數據',
        WIFI_READ_DATA: 'WiFi數據',
        OLED_CATEGORY: 'OLED',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['zh-cn'], {
        ...
        WIFI_READ_CONNECTED: '读取WiFi数据',
        WIFI_READ_DATA: 'WiFi数据',
        OLED_CATEGORY: 'OLED',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['it'], {
        ...
        MOTOR130_LEFT: "Motore sinistro Beetlebot INA#%1 livello %2 INB#%3 valore uscita simulata %4",
        MOTOR130_RIGHT: "Motore destro Beetlebot INA#%1 livello %2 INB#%3 valore uscita simulata %4",
        KS_SERVO_CATEGORY: "Servomotore",
        KS_SERVO_ANGLE: "Servomotore pin %1 angolo %2 ritardo (millisecondi) %3",
        ...
        MATRIX_IIC_CATEGORY: "Matrice 8*8 HT16K33",
        MATRIX_IIC_INIT: "Inizializza matrice HT16K33",
        MATRIX_IIC_FACE: "Matrice HT16K33 mostra %1",
        MATRIX_IIC_PIEXL: "Matrice HT16K33 mostra pixel X %1 Y %2 livello %3",
        MATRIX_IIC_REFRESH: "Matrice HT16K33 aggiorna display",
        MATRIX_IIC_CLEAR: "Matrice HT16K33 cancella schermo",
        ...
        IR_READ: "Leggi dati ricevitore infrarossi",
        IR_REFRESH: "Aggiorna dati ricevitore infrarossi",
        WIFI_CATEGORY: "WIFI",
        WIFI_INIT: "Collega WiFi nome %1 password %2",
        WIFI_READ_IP: "Leggi IP WiFi",
        WIFI_CLIENT_INIT: "Inizializza client WiFi",
        WIFI_CLIENT_CONNECTED: "WiFi non connesso al client",
        WIFI_READ_CONNECTED: "Leggi dati WiFi",
        WIFI_READ_DATA: "Dati WiFi",
        OLED_CATEGORY: "OLED",
        ...
        OLED_SETTEXT: "Imposta dimensione font %1 colore %2 sfondo %3",
        OLED_SETCURSOR: "Imposta cursore x: %1 y: %2",
        OLED_PRINT: "Stampa %1 %2",
        OLED_EOL_WARP: "Vai a capo",
        OLED_EOL_NOWARP: "Non vai a capo",
        OLED_IMAGE: "OLED mostra immagine %1",
        OLED_CLEAR: "Pulisci OLED",
        OLED_REFRESH: "Aggiorna OLED",
        OLED_STARTSCROLL: "Inizia a scorrere %1 y0: %2 y1: %3",
        OLED_SCROLL_RIGHT: "Scorrimento verso destra",
        OLED_SCROLL_LEFT: "Scorrimento verso sinistra",
        OLED_SCROLL_DIAGRIGHT: "Scorrimento diagonale destra",
        OLED_SCROLL_DIAGLEFT: "Scorrimento diagonale sinistra",
