...
function addMsg (Blockly) {
    ...
    Object.assign(Blockly.ScratchMsgs.locales['ja'], {
        KS_VARIABLE_LABEL:'変数タイプ',
         ...
         matrix_iic_DRAWRECTANGLE: 'Martix 描画長方形 x: %1 y: %2 :幅 %3 長さ: %4',
         matrix_iic_DRAWCIRCLE: 'Martix 円を描く x: %1 y: %2 :半径 %3 ',
         matrix_iic_SHOWCHAR: 'Martix 表示文字または数値: %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['pl'], {
        ...
        MATRIX_IIC_INIT: 'Macierz początkowa',
        MATRIX_IIC_PIEXL: 'Matryca Oś X%1 Oś Y%2 Stan%3',
        matrix_iic_DRAWLINE: 'Narysuj linię Martixa x0: %1 y0: %2, x1: %3 y1: %4',
