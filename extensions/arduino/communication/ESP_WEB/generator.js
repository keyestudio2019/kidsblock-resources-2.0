...
function addGenerator (Blockly) {
   //网页编辑初始化
  Blockly.Arduino.esp32_web_page_init = function() {
    ...
    Blockly.Arduino.definitions_['include_web'] = '#include <web.h>';
    Blockly.Arduino.definitions_['var_declare_AsyncWebServer'] = 'AsyncWebServer server(80);';
    //Blockly.Arduino.setups_['web_setup']  = 'web.init(server);\n'+branch+'\nserver.begin();\n';  
    var code = 'web.init(server);\n'+branch+'\nserver.begin();\n';
    return code;
   };

  //网页插入元素
  Blockly.Arduino.esp32_web_page_add = function() {
    ...
    var code = 'web.add'+addType+'(\"'+addType+id+'\", '+name+');\n';

    return code;
  };

  //网页插入温度元素
  Blockly.Arduino.esp32_web_page_addTemperatureCard = function() {
    var id = Blockly.Arduino.valueToCode(this, 'id', Blockly.Arduino.ORDER_ATOMIC);
    var name = Blockly.Arduino.valueToCode(this, 'name', Blockly.Arduino.ORDER_ATOMIC);
    var type = this.getFieldValue('type');
    var code = 'web.addTemperatureCard(\"TemperatureCard'+id+'\", '+name+','+type+');\n';

    return code;
  };

  //网页插入滑杆元素
  Blockly.Arduino.esp32_web_page_addSliderCard = function() {
    var id = Blockly.Arduino.valueToCode(this, 'id', Blockly.Arduino.ORDER_ATOMIC);
    var name = Blockly.Arduino.valueToCode(this, 'name', Blockly.Arduino.ORDER_ATOMIC);
    var type = this.getFieldValue('type');
    var code = 'web.addSliderCard(\"SliderCard'+id+'\", '+name+','+type+');\n';

    return code;
  };

  //网页链接滑杆变化事件
  Blockly.Arduino.esp32_web_page_attachSliderChanged = function() {
    var code = 'web.attachSliderChanged(sliderChanged);\n';
    return code;
  };

  //网页滑杆变化事件
  Blockly.Arduino.esp32_web_page_SliderChanged = function() {
    var branch = Blockly.Arduino.statementToCode(this, 'DO');
    branch = branch.replace(/(^\s*)|(\s*$)/g, "");//去除两端空格
  ...
  //网页滑杆ID
  Blockly.Arduino.esp32_web_page_Slider_id = function() {
    var id = Blockly.Arduino.valueToCode(this, 'id', Blockly.Arduino.ORDER_ATOMIC);
    id = id.replace(/\"/g,'');
   ...
   //网页链接按钮事件
  Blockly.Arduino.esp32_web_page_attachButtonClick = function() {
    var code = 'web.attachButtonClick(buttonClicked);\n';
    return code;
  };


  //网页按钮事件
  Blockly.Arduino.esp32_web_page_ButtonClick = function() {
    var branch = Blockly.Arduino.statementToCode(this, 'DO');
    branch = branch.replace(/(^\s*)|(\s*$)/g, "");//去除两端空格
  ...
  //网页按钮ID
  Blockly.Arduino.esp32_web_page_Button_id = function() {
    var id = Blockly.Arduino.valueToCode(this, 'id', Blockly.Arduino.ORDER_ATOMIC);
    id = id.replace(/\"/g,'');
  ...
  //网页插入折线图元素
  Blockly.Arduino.esp32_web_page_addLineChart = function() {
    var id = Blockly.Arduino.valueToCode(this, 'id', Blockly.Arduino.ORDER_ATOMIC);
    var name = Blockly.Arduino.valueToCode(this, 'name', Blockly.Arduino.ORDER_ATOMIC);
    ...
    var type = this.getFieldValue('type');
    var code = 'web.addLineChart(\"'+id+'\", '+name+', '+x_axis_value+', sizeof('+x_axis_value+')/sizeof('+x_axis_value+'[0]), '+y_axis_name+', '+y_axis_value+', sizeof('+x_axis_value+')/sizeof('+x_axis_value+'[0]));\n';

    return code;
  };

  //网页更新折线图元素
  Blockly.Arduino.esp32_web_page_updateLineChart = function() {
    var id = Blockly.Arduino.valueToCode(this, 'id', Blockly.Arduino.ORDER_ATOMIC);
    var x_axis_value = Blockly.Arduino.valueToCode(this, 'x_axis_value', Blockly.Arduino.ORDER_ATOMIC);
    x_axis_value = x_axis_value.replace(/\"/g,'');
    var y_axis_value = Blockly.Arduino.valueToCode(this, 'y_axis_value', Blockly.Arduino.ORDER_ATOMIC);
    y_axis_value = y_axis_value.replace(/\"/g,'');
    var type = this.getFieldValue('type');
    var code = 'web.updateLineChart(\"'+id+'\", '+x_axis_value+', sizeof('+x_axis_value+')/sizeof('+x_axis_value+'[0]), '+y_axis_value+', sizeof('+x_axis_value+')/sizeof('+x_axis_value+'[0]));\n';

    return code;
  };

  //网页更新元素
  Blockly.Arduino.esp32_web_page_update = function() {
    var id = Blockly.Arduino.valueToCode(this, 'id', Blockly.Arduino.ORDER_ATOMIC);
    var value = Blockly.Arduino.valueToCode(this, 'value', Blockly.Arduino.ORDER_ATOMIC);
    value = value.replace(/\"/g,'');
    var updateType = this.getFieldValue('updateType');
    var code = 'web.update'+updateType+'(\"'+updateType+id+'\", '+value+');\n';

    return code;
  };

  Blockly.Arduino.web_serial_init = function() {
  ...
  Blockly.Arduino.web_print_data_32 = function() {
  ...
  Blockly.Arduino.web_receive_data_32 = function() {
    var branch = Blockly.Arduino.statementToCode(this, 'data');
    branch = branch.replace(/(^\s*)|(\s*$)/g, "");
